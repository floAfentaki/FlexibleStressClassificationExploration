...
# plt.rcParams['pdf.use14corefonts'] = True  # Uses built-in Type 1 fonts
# plt.rcParams['pdf.fonttype'] = 42  # Ensures fonts are stored as Type 42 (TrueType)
...
plt.subplots_adjust(left=0.1, right=0.96, top=0.82, bottom=0.1, wspace=0.3, hspace=0.5)
...
# output_pdf_path = os.path.join(output_folder, 'fs.pdf')
# output_pdf_path = os.path.join(output_folder, 'fsPower.png')
# output_pdf_path = os.path.join(output_folder, 'fsPower.jpeg')
