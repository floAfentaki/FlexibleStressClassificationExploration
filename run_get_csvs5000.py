...
#         "DT/AffectiveROAD/disr/float_models_4_synth",
#         "DT/AffectiveROAD/disr/float_models_6_synth",
#         "DT/AffectiveROAD/disr/float_models_8_synth",
#         "DT/AffectiveROAD/disr/float_models_10_synth",
#     ],
#     "fisher_score": [
...
#         "DT/AffectiveROAD/fisher_score/float_models_4_synth",
#         "DT/AffectiveROAD/fisher_score/float_models_6_synth",
#         "DT/AffectiveROAD/fisher_score/float_models_8_synth",
#         "DT/AffectiveROAD/fisher_score/float_models_10_synth",
#     ],
#     "jmi": [
...
#         "DT/AffectiveROAD/jmi/float_models_4_synth",
#         "DT/AffectiveROAD/jmi/float_models_6_synth",
#         "DT/AffectiveROAD/jmi/float_models_8_synth",
#         "DT/AffectiveROAD/jmi/float_models_10_synth",
#     ]
# }
...
#         "SVM/AffectiveROAD/disr/float_models_4_synth",
#         "SVM/AffectiveROAD/disr/float_models_6_synth",
#         "SVM/AffectiveROAD/disr/float_models_8_synth",
#         "SVM/AffectiveROAD/disr/float_models_10_synth",
#     ],
#     "fisher_score": [
...
#         "SVM/AffectiveROAD/fisher_score/float_models_4_synth",
#         "SVM/AffectiveROAD/fisher_score/float_models_6_synth",
#         "SVM/AffectiveROAD/fisher_score/float_models_8_synth",
#         "SVM/AffectiveROAD/fisher_score/float_models_10_synth",
#     ],
#     "jmi": [
...
#         "SVM/AffectiveROAD/jmi/float_models_4_synth",
#         "SVM/AffectiveROAD/jmi/float_models_6_synth",
#         "SVM/AffectiveROAD/jmi/float_models_8_synth",
#         "SVM/AffectiveROAD/jmi/float_models_10_synth",
#     ]
# }

data_paths = {
    "disr": [
        "MLP/wesad/disr/float_models_4_synth",
        "MLP/wesad/disr/float_models_6_synth",
        "MLP/wesad/disr/float_models_8_synth",
        "MLP/wesad/disr/float_models_10_synth",
        "MLP/AffectiveROAD/disr/float_models_4_synth",
        "MLP/AffectiveROAD/disr/float_models_6_synth",
        "MLP/AffectiveROAD/disr/float_models_8_synth",
        "MLP/AffectiveROAD/disr/float_models_10_synth",
    ],
    "fisher_score": [
        "MLP/wesad/fisher_score/float_models_4_synth",
        "MLP/wesad/fisher_score/float_models_6_synth",
        "MLP/wesad/fisher_score/float_models_8_synth",
        "MLP/wesad/fisher_score/float_models_10_synth",
        "MLP/AffectiveROAD/fisher_score/float_models_4_synth",
        "MLP/AffectiveROAD/fisher_score/float_models_6_synth",
        "MLP/AffectiveROAD/fisher_score/float_models_8_synth",
        "MLP/AffectiveROAD/fisher_score/float_models_10_synth",
    ],
    "jmi": [
        "MLP/wesad/jmi/float_models_4_synth",
        "MLP/wesad/jmi/float_models_6_synth",
        "MLP/wesad/jmi/float_models_8_synth",
        "MLP/wesad/jmi/float_models_10_synth",
        "MLP/AffectiveROAD/jmi/float_models_4_synth",
        "MLP/AffectiveROAD/jmi/float_models_6_synth",
        "MLP/AffectiveROAD/jmi/float_models_8_synth",
        "MLP/AffectiveROAD/jmi/float_models_10_synth",
    ]
}
    ...
    for path in paths:
        ...
        if os.path.exists(file_path) and file_path.endswith('.csv'):
            try:
                ...
                required_columns = {'Dataset', 'Number', 'Accuracy', 'Area', 'Power'}
                if required_columns.issubset(df.columns):
                    # Ensure that we aren't mistakenly adding malformed rows
                    df = df.dropna(subset=['Dataset', 'Number', 'Accuracy', 'Area', 'Power'])
