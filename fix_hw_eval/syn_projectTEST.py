...
from write_mlp_verilogFA import write_mlp_verilog
...
# y_test = Y_test
# y_train = Y_train
# X_test_float=np.copy(X_test)*10**(-5)
...
# mlpfx.get_accuracy(X_test_float,y_test)
mlpfx.get_accuracy(X_test,y_test)
# print("ACCURACY W/ MLPFX", mlpfx.get_accuracy(X_test_float,y_test))
