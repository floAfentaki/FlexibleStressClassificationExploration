...
for i in range(len(pareto_x)):
    ...
    # print(filtered_data_dt[(filtered_data_dt['Area'] == pareto_x[i]) & (filtered_data_dt['Accuracy'] == pareto_y[i])]['bitwidth'].values[0])
    # q_list.append(filtered_data_dt[(filtered_data_dt['Area'] == pareto_x[i]) & (filtered_data_dt['Accuracy'] == pareto_y[i])]['bitwidth'].values[0])
    # print()
# print
...
for i in range(len(pareto_x)):
    ...
    # print(filtered_data_svm[(filtered_data_svm['Area'] == pareto_x[i]) & (filtered_data_svm['Accuracy'] == pareto_y[i])]['bitwidth'].values[0])
    # q_list.append(filtered_data_svm[(filtered_data_svm['Area'] == pareto_x[i]) & (filtered_data_svm['Accuracy'] == pareto_y[i])]['bitwidth'].values[0])
    # print()
# print
...
for i in range(len(pareto_x)):
    ...
    # q_list.append(filtered_data_mlp[(filtered_data_mlp['Area'] == pareto_x[i]) & (filtered_data_mlp['Accuracy'] == pareto_y[i])]['bitwidth'].values[0])
    # print()
# print
