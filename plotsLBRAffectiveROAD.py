...
# fig = plt.figure(figsize=(3.37, 1.8))  # Total width: 3.37in per subplot, 2 rows
...
# plt.subplots_adjust(left=0.1, right=0.96, top=0.92, bottom=0.14, wspace=0.3, hspace=0.3)
plt.subplots_adjust(left=0.1, right=0.96, top=0.97, bottom=0.16, wspace=0.25, hspace=0.4)
...
ax0.text(0.7, 0.1, 'd) DT', ha='left', va='center', transform=ax0.transAxes, fontsize=7)
...
ax1.text(0.74, 0.1, 'e) SVM', ha='left', va='center', transform=ax1.transAxes, fontsize=7)
...
ax2.text(0.87, 0.1, 'f) MLP', ha='left', va='center', transform=ax2.transAxes, fontsize=7)
